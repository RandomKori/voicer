...
MAX_DB = 100
r = 5
MAX_MEL_TIME_LENGTH = 700  # Maximum size of the time dimension for a mel spectrogram
MAX_MAG_TIME_LENGTH = 2000  # Maximum size of the time dimension for a spectrogram
WINDOW_TYPE='hann'
N_ITER = 50
